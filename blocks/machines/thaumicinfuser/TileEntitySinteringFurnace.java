package com.malekire.thaumcraft2port.blocks.machines.thaumicinfuser;
...
import com.malekire.thaumcraft2port.blocks.machines.thaumicinfuser.*;
public class TileEntitySinteringFurnace extends TileEntity implements ITickable
{
	...
	{	
		...
		{
			--this.burnTime;
			BlockThaumicInfuser.setState(true, world, pos);
		}
