...
import com.malekire.thaumcraft2port.util.Reference;
...
public class BlockThaumicInfuser extends BlockBase implements ITileEntityProvider
{
	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public static final PropertyBool BURNING = PropertyBool.create("burning");
	public BlockThaumicInfuser(String name) {
	...
	{
		return Item.getItemFromBlock(ModBlocks.THAUMIC_INFUSER);
		
	}
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(ModBlocks.THAUMIC_INFUSER);
